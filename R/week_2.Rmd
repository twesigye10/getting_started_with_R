...
We can use supporteR to easily create sub folders in our project using the  **create_project_sub_folders()** function. This will help us to keep the folder names uniform as we walk the journey together.
...
export and read in iris data

## Manipulating data

add some columns on the imported data
