...
## R Studio Project and GitHub set up

Create a new R Studio project and enable `Git`

Create repository with same name on GitHub

Add the R Studio project to Sourcetree

Connect `R Studio Project` and `GitHub repository`

## Main operations/tasks with version control with sourcetree
